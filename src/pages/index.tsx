...
const HomePage: React.FC = () => {
  ...
  headers={"Authorization": api_key}
        ...
        @media(max-width:767px){.hero{padding:calc(100px + env(safe-area-inset-top)) 20px 50px}.hero-content{display:flex;flex-direction:column;gap:32px}.hero-right{order:-1}.hero-left{text-align:left;order:1;padding:0}.hero-left h1{font-size:28px;letter-spacing:-0.5px;margin:0 0 16px 0;line-height:1.25}.hero-left p{font-size:17px;line-height:1.6;margin:0 0 24px 0;color:#6b7280}.hero-stats{display:flex;gap:12px;justify-content:space-between}.stat{background:#f8f9fa;border:1px solid #e5e7eb;border-radius:14px;padding:18px 12px;flex:1;min-width:0;text-align:center}.stat span{display:block;font-size:20px;font-weight:700;color:#1a1a1a}.stat small{display:block;font-size:12px;color:#6b7280;margin-top:6px}.mockup-wrapper{position:relative;width:100%;min-height:420px}.phone{position:absolute;left:0;top:0;width:65%;max-width:260px;border-radius:16px;box-shadow:0 20px 50px rgba(0,0,0,0.15)}.chat-area{min-height:280px;padding:12px}.msg p{font-size:14px;padding:10px 12px}.code-box{position:absolute;right:0;bottom:0;width:70%;max-width:280px;border-radius:12px;box-shadow:0 15px 40px rgba(0,0,0,0.2)}.code-header{padding:10px 14px}.code-body{font-size:11px;padding:14px;line-height:1.5}.sec-hdr{text-align:left;padding:0}.sec-hdr h2{font-size:28px}.sec-hdr p{font-size:17px}.features{padding:50px 16px}.features-grid{gap:12px}.fcard{padding:20px 16px}.fcard h3{font-size:16px}.fcard p{font-size:14px}.touchpoint{padding:50px 16px}.pills{justify-content:flex-start;gap:8px}.pill{padding:10px 18px;font-size:14px}.uc-box{padding:24px 20px;text-align:left}.uc-box h3{font-size:22px}.uc-box p{font-size:17px}.api{padding:50px 16px}.api-grid{gap:28px}.api-info{text-align:left}.api-info h2{font-size:28px}.api-info p{font-size:17px}.api-demo{border-radius:14px}.code-tabs{padding:12px 16px}.tab{padding:10px 20px;font-size:14px}.api-code{font-size:13px;padding:20px}.ftr{padding:16px}.ftr-link,.ftr-tagline{font-size:16px}}`}</style>
      </div>
    </>
  );
};
