...
const HomePage: React.FC = () => {
  ...
  headers={"Authorization": api_key}
        ...
        @media(max-width:767px){.hero{padding:calc(90px + env(safe-area-inset-top)) 16px 40px}.hero-content{display:flex;flex-direction:column;gap:20px}.hero-right{order:-1;margin-bottom:8px}.hero-left{text-align:left;order:1;padding:0 4px}.hero-left h1{font-size:26px;letter-spacing:-0.5px;margin:0 0 10px 0;line-height:1.2}.hero-left p{font-size:15px;line-height:1.5;margin:0 0 16px 0;color:#6b7280}.hero-stats{display:flex;gap:8px;justify-content:flex-start;margin-top:4px}.stat{background:#f8f9fa;border:1px solid #e5e7eb;border-radius:10px;padding:14px 10px;flex:1;min-width:0;text-align:center}.stat span{display:block;font-size:16px;font-weight:700;color:#1a1a1a}.stat small{display:block;font-size:10px;color:#6b7280;margin-top:3px}.mockup-wrapper{display:flex;flex-direction:column;gap:10px;width:100%;height:auto;min-height:auto;position:relative}.phone{position:relative;width:100%;margin:0;border-radius:14px;overflow:hidden}.chat-area{min-height:180px;padding:10px 8px}.msg p{font-size:12px;padding:6px 8px}.code-box{position:relative;width:100%;margin:0;border-radius:10px;overflow:hidden}.code-header{padding:6px 10px}.code-body{font-size:9px;padding:10px;max-height:100px;overflow:hidden;line-height:1.4}.sec-hdr{text-align:left;padding:0}.sec-hdr h2{font-size:28px}.sec-hdr p{font-size:17px}.features{padding:50px 16px}.features-grid{gap:12px}.fcard{padding:20px 16px}.fcard h3{font-size:16px}.fcard p{font-size:14px}.touchpoint{padding:50px 16px}.pills{justify-content:flex-start;gap:8px}.pill{padding:10px 18px;font-size:14px}.uc-box{padding:24px 20px;text-align:left}.uc-box h3{font-size:22px}.uc-box p{font-size:17px}.api{padding:50px 16px}.api-grid{gap:28px}.api-info{text-align:left}.api-info h2{font-size:28px}.api-info p{font-size:17px}.api-demo{border-radius:14px}.code-tabs{padding:12px 16px}.tab{padding:10px 20px;font-size:14px}.api-code{font-size:13px;padding:20px}.ftr{padding:16px}.ftr-link,.ftr-tagline{font-size:16px}}`}</style>
      </div>
    </>
  );
};
