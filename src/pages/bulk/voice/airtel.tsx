/**
 * Bulk Airtel IQ Voice Campaigns
 * Voice broadcast campaigns via Airtel IQ
 */
...
const BulkAirtelVoice: React.FC<PageProps> = ({ signOut, user }) => {
      ...
      <div className="voice-page">
        <div className="voice-header">
          ...
          <div className="voice-header-info">
            ...
            <div>
              <h1>Bulk Voice - Airtel IQ</h1>
              <span className="voice-provider">Voice Broadcast Campaigns</span>
            </div>
          </div>
        </div>
        ...
        <div className="tab-content">
          ...
          {activeTab === 'Create' && (
            <div className="create-section">
              <div className="coming-soon">
                ...
                <p>Voice broadcast campaign creation</p>
          ...
          {activeTab === 'Templates' && (
            <div className="coming-soon">
              ...
              <p>Pre-recorded audio templates</p>
              <span className="badge">Coming Soon</span>
            </div>
          )}
          ...
          {activeTab === 'Analytics' && (
            <div className="coming-soon">
              ...
              <p>Call completion rates and responses</p>
              <span className="badge">Coming Soon</span>
            </div>
          )}
        </div>
        ...
        <div className="info-panel">
          <h3>Airtel IQ Voice</h3>
          <div className="info-section">
            <h4>Features</h4>
            <ul><li>✓ Voice Broadcast</li><li>✓ IVR Campaigns</li><li>✓ Call Recording</li><li>✓ DND Compliance</li></ul>
          </div>
          <div className="info-section">
            <h4>Documentation</h4>
            <a href="https://www.airtel.in/business/b2b/airtel-iq/api-docs/voice/callflow-component-apis" target="_blank" rel="noopener noreferrer">Airtel IQ Voice API →</a>
          </div>
        </div>
        </div>
      </div>
...
export default BulkAirtelVoice;
