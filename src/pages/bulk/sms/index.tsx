/**
 * Bulk SMS Hub - SMS Provider Selection
 * Choose between Airtel IQ SMS and AWS Pinpoint SMS for bulk campaigns
 */
...
const SMS_PROVIDERS = [
  {
    ...
    name: 'Airtel IQ SMS',
    icon: '📱',
    description: 'Bulk SMS via Airtel IQ Gateway',
    href: '/bulk/sms/airtel',
    status: 'active',
  ...
  },
  {
    ...
    icon: '☎️',
    description: 'Bulk SMS via Amazon Pinpoint',
    href: '/bulk/sms/aws',
    status: 'active',
    features: ['Global Coverage', 'Campaign Analytics', 'Delivery Reports', 'Segmentation'],
  },
];
    ...
    <Layout user={user} onSignOut={signOut}>
      <div className="page">
        <div className="page-header">
          ...
          <p className="page-subtitle">Select SMS provider for bulk campaigns</p>
        </div>
